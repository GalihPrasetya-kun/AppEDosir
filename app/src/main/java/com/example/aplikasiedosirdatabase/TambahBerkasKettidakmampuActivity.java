...
public class TambahBerkasKettidakmampuActivity extends AppCompatActivity {
    Button btnBack, btnSave, btnPilihKettidakmampu;
    Uri filepath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_berkas_kettidakmampu);
        ...
        etTglLahirKettidakmampu = findViewById(R.id.etTglLahirKettidakmampu);

        btnPilihKettidakmampu = findViewById(R.id.btn_pilihFileKettidakmampu);
        btnPilihKettidakmampu.setOnClickListener(v -> {
    ...
    private void uploadFile(Uri filepath) {
        ...
        StorageReference mRef = mStore.child("Berkas Kettidakmampu/"+System.currentTimeMillis()+".pdf");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        mRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                KetTidakMampuListModel listKettidakmampu = new KetTidakMampuListModel(etNamaKettidakmampu.getText().toString(), etTglLahirKettidakmampu.getText().toString(), uri.toString());
                                mData.child(mData.push().getKey()).setValue(listKettidakmampu);

                                dialog.dismiss();
                                Toast.makeText(getApplicationContext(), "File Terupload.", Toast.LENGTH_SHORT).show();

                                etNamaKettidakmampu.setText("");
                                etTglLahirKettidakmampu.setText("");
                            }
                        });
                    }
                })
