...
public class TambahBerkasSerahActivity extends AppCompatActivity {
    Button btnBack, btnSave, btnPilihSerah;
    Uri filepath;
    EditText etNamaSerah, etTglLahirSerah;

    ImageView imgSerahPdf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSerahPdf.setOnClickListener(v -> {
            imgSerahPdf.setVisibility(View.INVISIBLE);
        });
        ...
        btnPilihSerah = findViewById(R.id.btn_pilihFileSerah);
        btnPilihSerah.setOnClickListener(v -> {
    ...
    private void uploadFile(Uri filepath) {
        ...
        StorageReference mRef = mStore.child("Berkas Serah/"+System.currentTimeMillis()+".pdf");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        mRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                SerahListModel listSerah = new SerahListModel(etNamaSerah.getText().toString(), etTglLahirSerah.getText().toString(), uri.toString());
                                mData.child(mData.push().getKey()).setValue(listSerah);

                                dialog.dismiss();
                                Toast.makeText(getApplicationContext(), "File Terupload.", Toast.LENGTH_SHORT).show();

                                etNamaSerah.setText("");
                                etTglLahirSerah.setText("");
                            }
                        });
                    }
                })
