...
public class TambahBerkasRegistrasiActivity extends AppCompatActivity {
    Button btnBack, btnSave, btnPilihRegistrasi;
    Uri filepath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilihRegistrasi = findViewById(R.id.btn_pilihFileRegistrasi);
        btnPilihRegistrasi.setOnClickListener(v -> {
    ...
    private void uploadFile(Uri filepath) {
        ...
        StorageReference mRef = mStore.child("Berkas Registrasi/"+System.currentTimeMillis()+".pdf");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        mRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                RegistrasiListModel listRegistrasi = new RegistrasiListModel(etNamaRegistrasi.getText().toString(), etTglLahirRegistrasi.getText().toString(), uri.toString());
                                mData.child(mData.push().getKey()).setValue(listRegistrasi);

                                dialog.dismiss();
                                Toast.makeText(getApplicationContext(), "File Terupload.", Toast.LENGTH_SHORT).show();

                                etNamaRegistrasi.setText("");
                                etTglLahirRegistrasi.setText("");
                            }
                        });
                    }
                })
